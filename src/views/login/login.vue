<template>
    <div class="form-demo mt-16 md:border-0 border-t-2 border-base-200 flex justify-center card bg-neutral md:w-[500px] w-full mx-auto text-neutral-content shadow-lg">
